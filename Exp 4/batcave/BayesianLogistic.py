...
#                  tol_solver=1e-3, fit_intercept=False, alpha=1e-6, verbose=False):
...
class VBLogisticRegression(BayesianLogisticRegression):
   ...
   [2] Murphy 2012, Machine Learning A Probabilistic Perspective ( Chapter 21 )
    ...
    def __init__(self, n_iter=10, tol=1e-3, fit_intercept=False,
    ...
    def _posterior_dist(self, X, l, a, b, XY, full_covar=False):
        ...
        if full_covar:
            ...
            print("mean, sigma", mean.shape, sigma.shape)
            return mean, sigma
        else:
            return mean, Ri